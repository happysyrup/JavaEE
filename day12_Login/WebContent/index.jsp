...
<html>
	...
	<body>
	<front>欢迎回来，${username.username}!</front>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/removeSession">退出</a>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
					Copyright &copy; 2005-2016 传智商城 版权所有<a href="${pageContext.request.contextPath}/findAll">展示所有商品</a>
				</div>
			</div>
		</div>
	</body>
